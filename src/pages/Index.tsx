...
// You'll need to lazy-load all your "TypeCurtainsSection" components
const TypeCurtainsSection = lazy(() => import("@/components/TypeCurtainsSection"));
const TypeCurtainsSection1 = lazy(() => import("@/components/TypeCurtainsSection1"));
const TypeCurtainsSection2 = lazy(() => import("@/components/TypeCurtainsSection2"));
const Tcs3 = lazy(() => import("@/components/Tcs3"));
