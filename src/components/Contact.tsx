...
const Contact = () => {
  return (
    <section id="contact" className="py-20 bg-charcoal-900 text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-8">
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-4">
                    <div className="bg-champagne-500 p-3 rounded-full">
                      <Phone className="w-6 h-6" />
                    </div>
                    <div>
                      <p className="font-semibold">Phone</p>
                      <p className="text-luxury-300">+92 300 1234567</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-luxury-300">info@azizkhanacurtains.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-luxury-300">Main Market, Lahore, Pakistan</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-luxury-300">Mon-Sun: 8AM - 10PM</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="bg-gradient-to-r from-champagne-500 to-champagne-600 p-6 rounded-xl">
          ...
          <Card className="bg-white text-charcoal-900">
