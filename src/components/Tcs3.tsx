...
//           Step into<br />
//           <i className='bg-gradient-to-r from-cyan-500 to-cyan-900 bg-clip-text text-transparent'>Serenity</i><br />
//           Aziz Khan Curtains,<br />
//           Tailored to You.  
//         </h2>
//         <p className="text-center sm:text-left text-lg text-gray-400 leading-relaxed">
//           Add softness, privacy, and temperature control to every room — all in one go 
//           Book Free Home Visit — Get Sample Fabrics & Design Advice at Home.
//         </p>
//       </div>
  ...
  return (
    <section className='bg-white'>
      <div className="max-w-7xl mx-auto px-4 py-10 flex flex-col lg:flex-row items-center justify-between gap-6">
        {/* Text Section */}
        <div className="lg:w-1/2 flex flex-col gap-4">
          <h2 className="text-center text-3xl sm:text-left sm:text-5xl font-bold bg-gradient-to-br from-champagne-500 to-champagne-900 bg-clip-text text-transparent">
            {headingLines}<br />
