  ...
  return (
    <section className='bg-white'>
      <div className="max-w-7xl mx-auto px-4 py-10 flex flex-col lg:flex-row items-center justify-between gap-6">
        {/* Text Section */}
        <div className="lg:w-1/2 flex flex-col gap-4">
          <h2 className="text-center text-lg sm:text-left sm:text-5xl font-bold bg-gradient-to-br from-champagne-500 to-champagne-900 bg-clip-text text-transparent">
            {headingLines}<br />
